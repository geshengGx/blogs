...
// 导入必要的模块
const js = require('@eslint/js'); // ESLint 官方推荐规则
const globals = require('globals'); // 提供全局变量定义
const vueParser = require('vue-eslint-parser'); // Vue 文件解析器
const vuePlugin = require('eslint-plugin-vue'); // Vue 专用规则
const tsEslint = require('@typescript-eslint/eslint-plugin'); // TS 规则插件
const tsParser = require('@typescript-eslint/parser'); // TS 解析器
const prettierConfig = require('eslint-config-prettier'); // 解决与 Prettier 的冲突
