...
module.exports = {
  ...
  overrides: [
    ...
    // ========== Vue 文件配置 ==========
    {
      ...
      rules: {
        // Vue深度选择器支持 (v-deep, ::v-deep, /deep/,"slotted", "global")
        "selector-pseudo-element-no-unknown": [
          true,
          {
            ignorePseudoElements: ["v-deep", "deep", "::v-deep", "slotted", "global"]
          }
        ],
  ...
  /**
   * 自定义规则
   * 注意：自定义属性顺序需要先安装 `stylelint-order` 插件
   */
  rules: {
    // ========== 基础样式规则 ==========
